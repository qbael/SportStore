...
INSERT INTO sanpham (ten, hinhanh, gianhap, giaban, mota, trangthai, thuonghieu, danhmuc, bomon, ncc)
VALUES ('Vợt Tennis Wilson Pro Staff', 'vot_tennis_wilson_pro_staff.jpg', 1500000, 2500000,
        'Vợt Tennis Wilson Pro Staff chính hãng', TRUE, 8, 1, 1, 1),
       ('Vợt Cầu Lông Yonex Astrox 88D', 'vot_cau_long_yonex_astrox_88d.jpg', 2000000, 3200000,
        'Vợt cầu lông Yonex Astrox 88D chính hãng', TRUE, 9, 1, 2, 2),
       ('Vợt Bóng Bàn Butterfly Timo Boll', 'vot_bong_ban_butterfly_timo_boll.jpg', 1200000, 1800000,
        'Vợt bóng bàn Butterfly Timo Boll chính hãng', TRUE, 9, 1, 3, 3),
       ...
       ('Giày Cầu Lông Yonex Power Cushion', 'giay_cau_long_yonex_power_cushion.jpg', 1600000, 2400000,
        'Giày cầu lông Yonex Power Cushion chính hãng', TRUE, 9, 2, 2, 2),
       ('Giày Bóng Bàn Butterfly Lezoline', 'giay_bong_ban_butterfly_lezoline.jpg', 1400000, 2200000,
        'Giày bóng bàn Butterfly Lezoline chính hãng', TRUE, 5, 2, 3, 3),
       ...
       ('Áo Cầu Lông Yonex Tournament', 'ao_cau_long_yonex_tournament.jpg', 550000, 850000,
        'Áo cầu lông Yonex Tournament chính hãng', TRUE, 9, 3, 2, 2),
       ('Quần Bóng Bàn Butterfly Swift', 'quan_bong_ban_butterfly_swift.jpg', 500000, 800000,
        'Quần bóng bàn Butterfly Swift chính hãng', TRUE, 3, 3, 3, 3),
       ...
       ('Vợt Tennis Babolat Pure Drive', 'vot_tennis_babolat_pure_drive.jpg', 1800000, 2900000,
        'Vợt Tennis Babolat Pure Drive chính hãng, công nghệ mới nhất', TRUE, 8, 1, 1, 1),
       ('Vợt Tennis Head Graphene 360+', 'vot_tennis_head_graphene_360+.jpg', 2200000, 3500000,
        'Vợt Tennis Head Graphene 360+ với khung carbon cao cấp', TRUE, 8, 1, 1, 1),
       ('Giày Tennis Asics Gel Resolution', 'giay_tennis_asics_gel_resolution.jpg', 1900000, 2800000,
        'Giày Tennis Asics Gel Resolution với đệm gel chống sốc', TRUE, 6, 2, 1, 1),
       ('Giày Tennis Adidas Barricade', 'giay_tennis_adidas_barricade.jpg', 2100000, 3200000,
        'Giày Tennis Adidas Barricade với độ bền cao', TRUE, 2, 2, 1, 1),
       ('Áo Tennis Nike Court Dri-FIT', 'ao_tennis_nike_court_dri-fit.jpg', 650000, 950000,
        'Áo Tennis Nike Court Dri-FIT thoáng khí, thấm hút mồ hôi', TRUE, 1, 3, 1, 1),
       ('Quần Tennis Under Armour', 'quan_tennis_under_armour.jpg', 550000, 850000,
        'Quần Tennis Under Armour co giãn 4 chiều', TRUE, 4, 3, 1, 1),
       ('Vợt Cầu Lông Li-Ning Windstorm', 'vot_cau_long_li-ning_windstorm.jpg', 1700000, 2600000,
        'Vợt Cầu Lông Li-Ning Windstorm siêu nhẹ', TRUE, 9, 1, 2, 2),
       ('Vợt Cầu Lông Victor Thruster', 'vot_cau_long_victor_thruster.jpg', 1900000, 2900000,
        'Vợt Cầu Lông Victor Thruster với khung carbon cứng', TRUE, 9, 1, 2, 2),
       ('Giày Cầu Lông Li-Ning Ranger', 'giay_cau_long_li-ning_ranger.jpg', 1500000, 2300000,
        'Giày Cầu Lông Li-Ning Ranger với đế cao su bám sân', TRUE, 9, 2, 2, 2),
       ('Giày Cầu Lông Victor SH-A830', 'giay_cau_long_victor_sh-a830.jpg', 1700000, 2500000,
        'Giày Cầu Lông Victor SH-A830 chống trượt tốt', TRUE, 9, 2, 2, 2),
       ('Áo Cầu Lông Victor Unisex', 'ao_cau_long_victor_unisex.jpg', 500000, 800000,
        'Áo Cầu Lông Victor Unisex thoáng mát', TRUE, 9, 3, 2, 2),
       ('Quần Cầu Lông Yonex Premium', 'quan_cau_long_yonex_premium.jpg', 600000, 900000,
        'Quần Cầu Lông Yonex Premium co giãn tốt', TRUE, 9, 3, 2, 2),
       ('Vợt Bóng Bàn DHS Hurricane', 'vot_bong_ban_dhs_hurricane.jpg', 1300000, 2000000,
        'Vợt Bóng Bàn DHS Hurricane chuyên nghiệp', TRUE, 9, 1, 3, 3),
       ('Vợt Bóng Bàn Stiga Offensive', 'vot_bong_ban_stiga_offensive.jpg', 1400000, 2100000,
        'Vợt Bóng Bàn Stiga Offensive tấn công mạnh mẽ', TRUE, 9, 1, 3, 3),
       ('Giày Bóng Bàn Mizuno Wave Drive', 'giay_bong_ban_mizuno_wave_drive.jpg', 1600000, 2400000,
        'Giày Bóng Bàn Mizuno Wave Drive nhẹ và linh hoạt', TRUE, 6, 2, 3, 3),
       ('Giày Bóng Bàn Stiga Perform', 'giay_bong_ban_stiga_perform.jpg', 1500000, 2300000,
        'Giày Bóng Bàn Stiga Perform với đế cao su đặc biệt', TRUE, 5, 2, 3, 3),
       ('Áo Bóng Bàn Butterfly Pro', 'ao_bong_ban_butterfly_pro.jpg', 550000, 850000,
        'Áo Bóng Bàn Butterfly Pro chất liệu cao cấp', TRUE, 3, 3, 3, 3),
       ('Quần Bóng Bàn Stiga Elite', 'quan_bong_ban_stiga_elite.jpg', 500000, 800000,
        'Quần Bóng Bàn Stiga Elite thoải mái khi di chuyển', TRUE, 3, 3, 3, 3);

-- Insert data into bienthe (product variants)
INSERT INTO bienthe (sanpham, tenbienthe, hinhanh, mau, size, soluongton)
VALUES (1, 'Vợt Tennis Wilson Pro Staff - Đen', 'vot_tennis_wilson_pro_staff_-_den.jpg', 1, NULL, 20),
       (1, 'Vợt Tennis Wilson Pro Staff - Đỏ', 'vot_tennis_wilson_pro_staff_-_do.jpg', 3, NULL, 15),
       (2, 'Vợt Cầu Lông Yonex Astrox 88D - Xanh dương', 'vot_cau_long_yonex_astrox_88d_-_xanh_duong.jpg', 4, NULL, 25),
       (2, 'Vợt Cầu Lông Yonex Astrox 88D - Đỏ', 'vot_cau_long_yonex_astrox_88d_-_do.jpg', 3, NULL, 20),
       (3, 'Vợt Bóng Bàn Butterfly Timo Boll - Đen/Đỏ', 'vot_bong_ban_butterfly_timo_boll_-_den_do.jpg', 1, NULL, 30),
       ...
       (5, 'Giày Cầu Lông Yonex Power Cushion - Xanh, size 40', 'giay_cau_long_yonex_power_cushion_-_xanh.jpg', 4, 8, 15),
       (5, 'Giày Cầu Lông Yonex Power Cushion - Xanh, size 41', 'giay_cau_long_yonex_power_cushion_-_xanh.jpg', 4, 9, 12),
       ...
       (11, 'Vợt Tennis Babolat Pure Drive - Xanh dương', 'vot_tennis_babolat_pure_drive_-_xanh_duong.jpg', 4, NULL, 18),
       (11, 'Vợt Tennis Babolat Pure Drive - Đen', 'vot_tennis_babolat_pure_drive_-_den.jpg', 1, NULL, 15),
       (12, 'Vợt Tennis Head Graphene 360+ - Đen/Vàng', 'vot_tennis_head_graphene_360+_-_den_vang.jpg', 1, NULL, 12),
       (12, 'Vợt Tennis Head Graphene 360+ - Trắng/Xanh', 'vot_tennis_head_graphene_360+_-_trang_xanh.jpg', 2, NULL, 10),
       (13, 'Giày Tennis Asics Gel Resolution - Xanh, size 40', 'giay_tennis_asics_gel_resolution_-_xanh.jpg', 4, 8, 8),
       (13, 'Giày Tennis Asics Gel Resolution - Xanh, size 41', 'giay_tennis_asics_gel_resolution_-_xanh.jpg', 4, 9, 10),
       (13, 'Giày Tennis Asics Gel Resolution - Xanh, size 42', 'giay_tennis_asics_gel_resolution_-_xanh.jpg', 4, 10, 7),
       ...
       (17, 'Vợt Cầu Lông Li-Ning Windstorm - Đỏ', 'vot_cau_long_li-ning_windstorm_-_do.jpg', 3, NULL, 15),
       (17, 'Vợt Cầu Lông Li-Ning Windstorm - Đen', 'vot_cau_long_li-ning_windstorm_-_den.jpg', 1, NULL, 12),
       (18, 'Vợt Cầu Lông Victor Thruster - Xanh', 'vot_cau_long_victor_thruster_-_xanh.jpg', 4, NULL, 14),
       (18, 'Vợt Cầu Lông Victor Thruster - Cam', 'vot_cau_long_victor_thruster_-_cam.jpg', 7, NULL, 10),
       ...
       (23, 'Vợt Bóng Bàn DHS Hurricane - Đỏ/Đen', 'vot_bong_ban_dhs_hurricane_do_den.jpg', 3, NULL, 20),
       (23, 'Vợt Bóng Bàn DHS Hurricane - Xanh/Đen', 'vot_bong_ban_dhs_hurricane_xanh_den.jpg', 4, NULL, 15),
       (24, 'Vợt Bóng Bàn Stiga Offensive - Đỏ/Đen', 'vot_bong_ban_stiga_offensive_do_den.jpg', 3, NULL, 18),
       (24, 'Vợt Bóng Bàn Stiga Offensive - Xanh/Đen', 'vot_bong_ban_stiga_offensive_xanh_den.jpg', 4, NULL, 14),
